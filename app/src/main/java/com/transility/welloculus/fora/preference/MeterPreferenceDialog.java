package com.transility.welloculus.fora.preference;
...
import com.transility.welloculus.fora.constant.PCLinkLibraryDemoEnum.LeavePageState;
import com.transility.welloculus.fora.fragment.FullScreenDialogFragmentBase;
...
import com.transility.welloculus.fora.util.SharePreferencesUtils;
import com.transility.welloculus.fora.view.SearchMeterDialog;
        ...
        public void onClick(View v) {
        	if (mSearch.getTag().toString().equals("0")) {
        		...
        		new Handler().postDelayed(new Runnable() {
					...
					@Override
					public void run() {
						if (mSearchMeterDialog == null || !mSearchMeterDialog.isShowing()) {
							processScanDeviceTimeout();
						}
					}
				}, SCAN_PERIOD);
		...
		getActivity().runOnUiThread(new Runnable() {
			...
			public void run() {
				if (mSearchMeterDialog == null) {
					...
					mSearchMeterDialog.setOnSearchBLEClickListener(MeterPreferenceDialog.this);
